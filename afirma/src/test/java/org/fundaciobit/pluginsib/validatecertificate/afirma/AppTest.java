package org.fundaciobit.pluginsib.validatecertificate.afirma;
...
public class AppTest extends TestCase {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      File parent = new File("..\\certificats\\");
      ...
      File pkcs7 = new File(parent, "CAMERFIRMA\\lp_se_es_sw_kpsc_valido.crt"); // <=== CHANGE THIS
      ...
      String afirma_url_base = "https://afirmades.caib.es:4430/afirmaws/services";
      ...
      */
      ...
      try {
        ...
        ResultatValidacio rv = validaCert.validar(data,
