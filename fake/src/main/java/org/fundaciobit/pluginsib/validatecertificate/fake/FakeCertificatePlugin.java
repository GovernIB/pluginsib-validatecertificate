...
public class FakeCertificatePlugin implements ICertificatePlugin {
    ...
    public ResultatValidacio getInfoCertificate(X509Certificate cert) throws Exception {
        ...
        if (info.getNomResponsable() != null && info.getLlinatgesResponsable() != null) {
            info.setNomCompletResponsable(info.getNomResponsable() + " " + info.getLlinatgesResponsable());
        } else {
        ...
        Map<String, String> subjectProperties = new HashMap<String, String>();
        {
            ...
            for (Rdn rdn : ldapDN.getRdns()) {
                ...
                if (value instanceof byte[]) {
                    ...
                    String str = new String(thearray, StandardCharsets.UTF_8);
                    
                    
                    
                    
                    if (32 > (int)str.charAt(0))    {
                        str = str.substring(1);
                        System.out.println(" CHAR <32  => " + (int)str.charAt(0));
                    }
                    ...
                    System.out.println(" CHAR2 <32  => " + (int)str.charAt(0));
                    ...
                    */
                    ...
                    if ("O".equals(type) && value != null) {
                        subjectProperties.put("O", (String)value);
                        info.setEntitatSubscriptoraNom((String)value);
                        
                    }
                    
                    
                    if ("CN".equals(type) && value != null) {
                        info.setNomCompletResponsable((String)value);
                    }
        ...
        {
            String docRepre = subjectProperties.get("2.5.4.13");
            if (docRepre != null) {
                if (docRepre.startsWith("f")) {
                    info.setDocumentRepresentacio(docRepre.substring(1));
                } else {
                info.setDocumentRepresentacio(docRepre);
                }
            }
        }
        ...
        Map<Integer, String> subjectAlternativeProperties = new HashMap<Integer, String>();
        {
            ...
            if (subjectAltNames != null) {
                for (Object subjectAltName : subjectAltNames) {
                    ...
                    //System.out.println("XYZ ZZZ subjectAltName: " + subjectAltName);
                    ...
                    //
                    {
                        ...
                        if (altName != null) {
                            ...
                            if (altNameType == 1) {
                                // EMAIL
                                info.setEmail(altName);
                            } else if (altNameType == 2) {
                                // NOM DOMINI
