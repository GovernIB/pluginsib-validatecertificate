...
public class InformacioCertificat {
    ...
    public String toString() {
        ...
        st.append("Classificació Espanya (" + getClassificacio() + "): ");
        ...
        st.append("Primer Llinatge Responsable: ").append(getPrimerLlinatgeResponsable()).append("\n");
        st.append("Segon Llinatge Responsable: ").append(getSegonLlinatgeResponsable()).append("\n");
        ...
        st.append("Numero Identificacion Personal: ").append(getNumeroIdentificacionPersonal()).append("\n");
        ...
        st.append("Denominació Sistema Component: ").append(getDenominacioSistemaComponent()).append("\n");

        st.append("Entitat Subscriptora Nom: ").append(getEntitatSubscriptoraNom()).append("\n");
        st.append("Entitat Subscriptora Nif/Cif: ").append(getEntitatSubscriptoraNif()).append("\n");
    ...
    public String[] compareTo(InformacioCertificat obj) {
        ...
        comparaCamp(errors, creatAmbUnDispositiuSegur, obj.creatAmbUnDispositiuSegur, "creatAmbUnDispositiuSegur");
        ...
        comparaCamp(errors, entitatSubscriptoraNif, obj.entitatSubscriptoraNif, "entitatSubscriptoraNif");

        comparaCamp(errors, entitatSubscriptoraNom, obj.entitatSubscriptoraNom, "entitatSubscriptoraNom");
        ...
        comparaCamp(errors, nomCompletResponsable, obj.nomCompletResponsable, "nomCompletResponsable");
        ...
        comparaCamp(errors, primerLlinatgeResponsable, obj.primerLlinatgeResponsable, "primerLlinatgeResponsable");

        comparaCamp(errors, pseudonim, obj.pseudonim, "pseudonim");

        comparaCamp(errors, raoSocial, obj.raoSocial, "raoSocial");

        comparaCamp(errors, segonLlinatgeResponsable, obj.segonLlinatgeResponsable, "segonLlinatgeResponsable");
        ...
        comparaCamp(errors, unitatOrganitzativaNifCif, obj.unitatOrganitzativaNifCif, "unitatOrganitzativaNifCif");
