...
%>
<un:useConstants var="ValidationStatus" className="org.fundaciobit.plugins.validatecertificate.api.ValidationStatus" />

<div style="margin:10px;">
<br>

    <h3 class="tabs_involved"><fmt:message key="validatecertificate.final.msg1" /></h3>
    <fmt:message key="validatecertificate.final.msg2" />
       ...
       %>
            ...
            <tr>
                <td>
                  ...
                  <c:set var="status" value="${response.resultatValidacioCodi}" ></c:set>
                  ...
                  <c:choose>
                     <c:when test = "${status != 0}">
                        ...
                        Ra&oacute: <b style="color:red">${response.resultatValidacioDescripcio}</b>
            ...
            <tr>
                <td>
                  <h4>Informaci&oacute; del Certificat</h4>
                  <table class="table">
                     <tr>
                       <td>
                     <%
                     InfoGlobal infoGlobal = request.getAttribute("infoGlobal");
                     %>  
                     <%=infoGlobal.validateResponse.getInformacioCertificat().toString() %>
                            <%-- 
